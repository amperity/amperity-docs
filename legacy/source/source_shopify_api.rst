...
The feed and domain table for customer tags has the following fields:
...
The feed and domain table for discount allocations has the following fields:
...
The feed and domain table for discount codes has the following fields:
...
The feed and domain table for locations has the following fields:
...
The feed and domain table for order lines has the following fields:
...
The feed and domain table for order line refunds has the following fields:
...
The feed and domain table for order tags has the following fields:
...
The feed and domain table for products has the following fields:
...
The feed and domain table for product tags has the following fields:
...
The feed and domain table for product variants has the following fields:
