...
Semantic exclusions define a threshold over which records like these will be collapsed into a trivial duplicate. For example, a semantic exclusion for **email** and the size threshold at "10".
