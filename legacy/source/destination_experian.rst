...
.. |plugin-name| replace:: Experian
.. |what-send| replace:: CSV files
.. |email-plus-send| replace:: additional attributes
.. |filter-the-list| replace:: "exp"
...
.. |sendto-link| replace:: |sendto_experian|
...
.. note:: This topic contains information for configuring a destination to send audiences to |destination-name| using campaigns. To configure a destination for sending query results to |destination-name| using orchestrations see `this topic <https://docs.amperity.com/datagrid/destination_experian.html>`__ |ext_link|.

.. include:: ../../shared/terms.rst
   :start-after: .. term-experian-start
   :end-before: .. term-experian-end

.. destination-experian-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-experian-get-details>`
#. :ref:`Add destination <destination-experian-add-destination>`
#. :ref:`Add data template <destination-experian-add-data-template>`

.. destination-experian-steps-to-send-end


.. _destination-experian-get-details:

Get details
==================================================

.. destination-experian-get-details-start
...
.. destination-experian-get-details-end


.. _destination-experian-add-destination:
...
.. destination-experian-add-destination-steps-start
...
.. destination-experian-add-destination-steps-end


.. _destination-experian-add-data-template:
...
.. destination-experian-add-data-template-steps-start
...
.. destination-experian-add-data-template-steps-end


.. _destination-experian-workflow-actions:
...
.. destination-experian-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`destination-experian-workflow-actions-invalid-credentials`
       * :ref:`destination-experian-workflow-actions-sftp-unavailable`
...
.. destination-experian-workflow-actions-end


.. _destination-experian-workflow-actions-invalid-credentials:
...
.. _destination-experian-workflow-actions-sftp-unavailable:
