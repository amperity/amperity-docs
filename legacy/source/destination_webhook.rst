...
* `Amazon Pinpoint <https://docs.amperity.com/datagrid/destination_amazon_pinpoint>`__
* `Amazon Redshift <https://docs.amperity.com/datagrid/destination_amazon_redshift>`__
* `Microsoft Dataverse <https://docs.amperity.com/datagrid/destination_microsoft_dataverse>`__
...
#. Clone the open source |ext_amperity_lambda_runner| repository or download it as a ZIP file.
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/destinations.rst
       ...
       .. note:: Serverless destinations (such as `Amazon Pinpoint <https://docs.amperity.com/datagrid/destination_amazon_pinpoint>`__ and `Amazon Redshift <https://docs.amperity.com/datagrid/destination_amazon_redshift>`__ use empty webhook settings: "{ }". A custom webhook will often need to specify a JSON object.
...
#. Open the Amperity open source toolkit: |ext_amperity_lambda_runner|.
