...
Users that connects to Snowflake to use data in external applications, such as Tableau, Microsoft Power BI, and Databricks, need to be granted read-only access to the Snowflake data warehouse. 
