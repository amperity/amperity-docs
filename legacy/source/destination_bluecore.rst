...
.. |sendto-link| replace:: |sendto_bluecore|
...
.. note:: This topic contains information for configuring a destination to send audiences to |destination-name| using campaigns. To configure a destination for sending query results to |destination-name| using orchestrations see `this topic <https://docs.amperity.com/datagrid/destination_bluecore.html>`__ |ext_link|.

.. include:: ../../shared/terms.rst
   :start-after: .. term-bluecore-start
   :end-before: .. term-bluecore-end

.. destination-bluecore-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-bluecore-get-details>`
#. :ref:`Add destination <destination-bluecore-add-destination>`
#. :ref:`Add data template <destination-bluecore-add-data-template>`

.. destination-bluecore-steps-to-send-end


.. _destination-bluecore-get-details:

Get details
==================================================

.. destination-bluecore-get-details-start
...
.. destination-bluecore-get-details-end


.. _destination-bluecore-add-destination:
...
.. destination-bluecore-add-destination-steps-start
...
.. destination-bluecore-add-destination-steps-end


.. _destination-bluecore-add-data-template:
...
.. destination-bluecore-add-data-template-steps-start
...
.. destination-bluecore-add-data-template-steps-end


.. _destination-bluecore-workflow-actions:
...
.. destination-bluecore-workflow-actions-start
...
.. destination-bluecore-workflow-actions-end


.. _destination-bluecore-workflow-actions-invalid-credentials:
...
.. _destination-bluecore-workflow-actions-sftp-unavailable:
