...
.. |sendto-link| replace:: |sendto_kibo|
...
.. note:: This topic contains information for configuring a destination to send audiences to |destination-name| using campaigns. To configure a destination for sending query results to |destination-name| using orchestrations see `this topic <https://docs.amperity.com/datagrid/destination_kibo.html>`__ |ext_link|.

.. include:: ../../shared/terms.rst
   :start-after: .. term-kibo-start
   :end-before: .. term-kibo-end

.. destination-kibo-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-kibo-get-details>`
#. :ref:`Add destination <destination-kibo-add-destination>`
#. :ref:`Add data template <destination-kibo-add-data-template>`

.. destination-kibo-steps-to-send-end


.. _destination-kibo-get-details:

Get details
==================================================

.. destination-kibo-get-details-start
...
.. destination-kibo-get-details-end
...
.. _destination-kibo-add-destination:
...
.. destination-kibo-add-destination-steps-start
...
.. destination-kibo-add-destination-steps-end


.. _destination-kibo-add-data-template:
...
.. destination-kibo-add-data-template-steps-start
...
.. destination-kibo-add-data-template-steps-end


.. _destination-kibo-workflow-actions:
...
.. destination-kibo-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`destination-kibo-workflow-actions-invalid-credentials`
       * :ref:`destination-kibo-workflow-actions-sftp-unavailable`
...
.. destination-kibo-workflow-actions-end


.. _destination-kibo-workflow-actions-invalid-credentials:
...
.. _destination-kibo-workflow-actions-sftp-unavailable:
