...
.. |sendto-link| replace:: |sendto_acxiom|
...
.. note:: This topic contains information for configuring a destination to send audiences to |destination-name| using campaigns. To configure a destination for sending query results to |destination-name| using orchestrations see `this topic <https://docs.amperity.com/datagrid/destination_acxiom.html>`__ |ext_link|.

.. include:: ../../shared/terms.rst
   :start-after: .. term-acxiom-start
   :end-before: .. term-acxiom-end

.. destination-acxiom-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-acxiom-get-details>`
#. :ref:`Add destination <destination-acxiom-add-destination>`
#. :ref:`Add data template <destination-acxiom-add-data-template>`

.. destination-acxiom-steps-to-send-end


.. _destination-acxiom-get-details:

Get details
==================================================

.. destination-acxiom-get-details-start
...
.. destination-acxiom-get-details-end


.. _destination-acxiom-add-destination:
...
.. destination-acxiom-add-destination-steps-start
...
.. destination-acxiom-add-destination-steps-end


.. _destination-acxiom-add-data-template:
...
.. destination-acxiom-add-data-template-steps-start
...
.. destination-acxiom-add-data-template-steps-end


.. _destination-acxiom-workflow-actions:
...
.. destination-acxiom-workflow-actions-start
...
.. destination-acxiom-workflow-actions-end


.. _destination-acxiom-workflow-actions-invalid-credentials:
...
.. _destination-acxiom-workflow-actions-sftp-unavailable:
