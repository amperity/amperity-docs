...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - Send a test from Amperity.
       ...
       .. important:: Be sure to send all fields from Amperity that is required by |destination-name|. The **name**, **email** or **external_id** fields must be included.
