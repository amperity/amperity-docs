...
.. |sendto-link| replace:: |sendto_powerreviews|
...
.. destination-powerreviews-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-powerreviews-get-details>`
#. :ref:`Add destination <destination-powerreviews-add-destination>`
#. :ref:`Add data template <destination-powerreviews-add-data-template>`

.. destination-powerreviews-steps-to-send-end


.. _destination-powerreviews-get-details:

Get details
==================================================

.. destination-powerreviews-get-details-start
...
.. destination-powerreviews-get-details-end


.. _destination-powerreviews-add-destination:
...
.. destination-powerreviews-add-destination-steps-start
...
.. destination-powerreviews-add-destination-steps-end


.. _destination-powerreviews-add-data-template:
...
.. destination-powerreviews-add-data-template-steps-start
...
.. destination-powerreviews-add-data-template-steps-end


.. _destination-powerreviews-workflow-actions:
...
.. destination-powerreviews-workflow-actions-start
...
.. destination-powerreviews-workflow-actions-end


.. _destination-powerreviews-workflow-actions-invalid-credentials:
...
.. _destination-powerreviews-workflow-actions-sftp-unavailable:
