...
.. |plugin-name| replace:: Neustar
.. |what-send| replace:: CSV files
.. |email-plus-send| replace:: additional attributes
.. |filter-the-list| replace:: "neu"
...
.. |sendto-link| replace:: |sendto_neustar|
...
.. note:: This topic contains information for configuring a destination to send audiences to |destination-name| using campaigns. To configure a destination for sending query results to |destination-name| using orchestrations see `this topic <https://docs.amperity.com/datagrid/destination_neustar.html>`__ |ext_link|.
...
#. :ref:`Get details <destination-neustar-get-details>`
#. :ref:`Add destination <destination-neustar-add-destination>`
#. :ref:`Add data template <destination-neustar-add-data-template>`

.. destination-neustar-steps-to-send-end


.. _destination-neustar-get-details:

Get details
==================================================

.. destination-neustar-get-details-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-check-off-black.png
     ...
     - The username and passphrase.
       ...
       .. note:: Neustar requires SFTP passphrase to be rotated every 180 days. When rotated, it must also be updated in Amperity. 
...
.. destination-neustar-get-details-end


.. _destination-neustar-add-destination:
...
.. destination-neustar-add-destination-steps-start
...
.. destination-neustar-add-destination-steps-end


.. _destination-neustar-add-data-template:
...
.. destination-neustar-add-data-template-steps-start
...
.. destination-neustar-add-data-template-steps-end


.. _destination-neustar-workflow-actions:
...
.. destination-neustar-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`destination-neustar-workflow-actions-invalid-credentials`
       * :ref:`destination-neustar-workflow-actions-sftp-unavailable`
...
.. destination-neustar-workflow-actions-end


.. _destination-neustar-workflow-actions-invalid-credentials:
...
.. _destination-neustar-workflow-actions-sftp-unavailable:
