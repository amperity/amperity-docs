...
#. :ref:`Get sample tables <source-klaviyo-get-sample-tables>`
#. :ref:`Add feeds <source-klaviyo-add-feeds>`
#. :ref:`Add load operations <source-klaviyo-add-load-operations>`
...
#. Access to an active Klaviyo account using a private API key. Create an API key in Klaviyo for use by FiveTran, and then provide the private API key to Amperity support. They will need this to complete the configuration of FiveTran.
...
.. source-klaviyo-add-courier-example-table-list-start
...
::
   ...
   [
     "AMPERITY_A1BO987C.KLAVIYO_ACME.CAMPAIGN",
     "AMPERITY_A1BO987C.KLAVIYO_ACME.LIST",
     "AMPERITY_A1BO987C.KLAVIYO_ACME.PERSON",
   ]

.. source-klaviyo-add-courier-example-table-list-end
...
.. source-klaviyo-add-courier-example-stage-name-start

For example:

::

   AMPERITY_A1BO987C.KLAVIYO_ACME.ACME_STAGE

.. source-klaviyo-add-courier-example-stage-name-end
...
.. source-klaviyo-add-courier-example-load-operation-start
...
::

   {
     "df-xxxxx": [
       {
         "type": "load",
         "file": "AMPERITY_A1BO987C.KLAVIYO_ACME.CAMPAIGN"
       }
     ],
     "df-xxxxx": [
       {
         "type": "load",
         "file": "AMPERITY_A1BO987C.KLAVIYO_ACME.LIST"
       }
     ],
     "df-xxxxx": [
       {
         "type": "load",
         "file": "AMPERITY_A1BO987C.KLAVIYO_ACME.PERSON"
       }
     ]
   }

.. source-klaviyo-add-courier-example-load-operation-end
...
.. _source-klaviyo-get-sample-tables:
...
.. _source-klaviyo-add-load-operations:
...
.. source-klaviyo-add-load-operations-example-start
...
.. source-klaviyo-add-load-operations-example-end
