...
.. _grid-segments-features:

Segments features
==================================================

.. grid-segments-features-about-start

Use the **Segments** page to build audieneces using attributes, conditions, and operators, inclusions or exclusions, and activation IDs.

.. grid-segments-features-about-end

.. grid-segments-features-about-grid-start
...
The following examples show using the visual **Segment Editor** to build audiences.
