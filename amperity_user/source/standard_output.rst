...
.. note:: The **Customer Attributes** table is built and often customized for your tenant. It is not part of standard output until after it has been added to your tenant, but is included here because it is often used with standard output to support a variety of complex use cases, such as churn prevention campaigns.
