...
.. list-table::
   ...
   * - Customer profile attributes
     - :ref:`Review the list of customer profile parameters <channel-klaviyo-customer-profile-parameters>` your brand can send to |destination-name|. These may be configured as default attributes in Amperity.

.. channel-klaviyo-configure-default-attributes-end


.. _channel-klaviyo-customer-profile-parameters:
