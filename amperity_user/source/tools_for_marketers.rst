...
The left-side navigation (from top to bottom) uses a verb-based approach to organize around the series of actions that you may do when defining audiences, and then building campaigns that send audience lists to a variety of marketing channels.
