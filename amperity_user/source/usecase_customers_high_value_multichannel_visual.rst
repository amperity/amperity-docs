...
.. include:: ../../amperity_user/source/usecase_customers_high_value_multichannel.rst
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-05.png
          ...
          :align: center
          :class: no-scaled-link
     - You are done. Give your query a name that describes the purpose. For example: "High Value Multichannel Purchases".
