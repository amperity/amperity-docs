...
:canonical: https://docs.amperity.com/api/endpoint_get_profile_index.html
...
A response from the **GET /indexes** endpoint will match an :doc:`HTTP status code <responses>`. A 200 response will contain the results set. A 4xx response indicates an issue with the configuration of your request. A 5xx response indicates that the endpoint is unavailable.
