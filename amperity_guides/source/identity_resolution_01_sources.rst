...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: Amazon S3
      :link-type: doc
      :link: identity_resolution_01_sources_amazon_s3

   .. grid-item-card:: Azure Blob Storage
      :link-type: doc
      :link: identity_resolution_01_sources_azure_blob_storage

   .. grid-item-card:: Databricks
      :link-type: doc
      :link: identity_resolution_01_sources_databricks

   .. grid-item-card:: Google BigQuery
      :link-type: doc
      :link: identity_resolution_01_sources_google_bigquery

   .. grid-item-card:: SFTP
      :link-type: doc
      :link: identity_resolution_01_sources_sftp

   .. grid-item-card:: Snowflake
      :link-type: doc
      :link: identity_resolution_01_sources_snowflake
...
.. toctree::
   ...
   Amazon S3 <identity_resolution_01_sources_amazon_s3>
   Azure Blob Storage <identity_resolution_01_sources_azure_blob_storage>
   Databricks <identity_resolution_01_sources_databricks>
   Google BigQuery <identity_resolution_01_sources_google_bigquery>
   SFTP <identity_resolution_01_sources_sftp>
   Snowflake <identity_resolution_01_sources_snowflake>
