...
.. source-databricks-prerequisites-end

**To add an inbound bridge**

.. source-databricks-add-bridge-steps-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-02.png
          ...
          :align: center
          :class: no-scaled-link
     - Connect the bridge to |source-name| by uploading the credential file that was downloaded from the `activation link <https://docs.databricks.com/en/data-sharing/create-recipient.html#step-2-get-the-activation-link>`__ |ext_link|. There are two ways to upload the credential file:
...
.. source-databricks-add-bridge-steps-end
