...
.. note:: Review `Connect Amperity Bridge to Snowflake <../operator/bridge_snowflake.html>`__ for more information about prerequisites, requirements, and optional configurations for |source-name|. All configuration prerequisites must be completed before stepping through this workflow.

.. source-snowflake-prerequisites-end

**To add an inbound bridge**

.. source-snowflake-add-bridge-steps-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-04.png
          ...
          :align: center
          :class: no-scaled-link
     - Use the **Select tables** dialog box to select any combination of schemas and tables to connect to Amperity.
       ...
       If you select a schema, all tables in the schema will be connected. Any new tables added later need to be manually added to the connection.
   ...
   * - .. image:: ../../images/steps-05.png
          ...
          :align: center
          :class: no-scaled-link
     - Map the tables connected from |source-name| to domain tables in Amperity.
       ...
       .. tip:: Use a custom domain table to assign primary keys, apply semantic tags, and shape data within connected tables to the requirements of your workflows in Amperity.

       When finished, click **Save and sync**. This will start a workflow that synchronizes data from |source-name| to Amperity and creates the mapped table names.

       You can manually sync tables connected with Amperity using the **Sync** option from the **Actions** menu for the inbound bridge.

.. source-snowflake-add-bridge-steps-end
