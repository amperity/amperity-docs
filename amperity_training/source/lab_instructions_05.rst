...
#. Ask the **AI Assistant** to help generate a query by pasting the following question in the **AI Assistant** message box and clicking the send button: "What is the most popular product of all time?"

   This is an example of a good query use case--not directly tied to a list of customers. How can you tell the **AI Assistant** generated a good result?
