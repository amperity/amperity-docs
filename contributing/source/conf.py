...
html_baseurl = "https://docs.amperity.com/contributing/"
sitemap_url_scheme = "contributing/{link}"
...
#    "github_path": "https://github.com/amperity/amperity-docs/tree/main/contributing/source/", # Path in the checkout to the docs root
}
