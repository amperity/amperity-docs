...
Access the advanced search from the navigation bar by clicking the filter icon to the right of the navigation search box *or* after using navigation search click the **Open advanced search** button.
...
Use the **Topic collections** filter to choose which topic collections to include in search results. At least one topic collection must be selected and all are selected by default.
