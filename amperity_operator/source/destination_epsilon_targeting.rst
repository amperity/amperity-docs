...
.. |destination-name| replace:: Epsilon Targeting
.. |plugin-name| replace:: "Epsilon Targeting"
.. |credential-type| replace:: "epsilon-targeting"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Epsilon Targeting.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Epsilon Targeting
...
.. _destination-epsilon-targeting-get-details:
...
.. destination-epsilon-targeting-get-details-table-start
...
.. destination-epsilon-targeting-get-details-table-end


.. _destination-epsilon-targeting-credentials:
...
**To configure credentials for Epsilon Targeting**

.. destination-epsilon-targeting-credentials-steps-start
...
.. destination-epsilon-targeting-credentials-steps-end


.. _destination-epsilon-targeting-add:
...
**To add a destination for Epsilon Targeting**

.. destination-epsilon-targeting-add-steps-start
...
.. destination-epsilon-targeting-add-steps-end
