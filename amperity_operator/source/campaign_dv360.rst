...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to DV360.
...
.. campaign-dv360-api-note-end


.. _campaign-dv360-get-details:
...
.. campaign-dv360-get-details-table-start
...
.. campaign-dv360-get-details-end


.. _campaign-dv360-credentials:
...
.. campaign-dv360-credentials-steps-start
...
.. campaign-dv360-credentials-steps-end


.. _campaign-dv360-reauthorize-amperity:
...
.. campaign-dv360-add-steps-start
...
.. campaign-dv360-api-matching-start
...
.. campaign-dv360-api-matching-end


.. _campaign-dv360-api-matching-contact:
...
.. campaign-dv360-api-matching-contact-list-end


.. _campaign-dv360-api-matching-eu-consent:

European Union user consent
--------------------------------------------------

.. campaign-dv360-api-matching-eu-consent-start
...
.. important:: Customers must `send the required user consent signals <https://support.google.com/google-ads/answer/14310715>`__ |ext_link| when uploading data for advertising to customers in the European Economic Area (EEA) and/or to adhere to the European Union (EU) user consent policy.
...
.. campaign-dv360-api-matching-eu-consent-end


.. _campaign-dv360-api-matching-mobile:
