...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Adobe Customer Attributes.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Adobe Customer Attributes
...
.. _campaign-adobe-customer-attributes-get-details:
...
.. campaign-adobe-customer-attributes-get-details-table-start
...
.. campaign-adobe-customer-attributes-get-details-table-end


.. _campaign-adobe-customer-attributes-credentials:
...
.. campaign-adobe-customer-attributes-credentials-steps-start
...
.. campaign-adobe-customer-attributes-credentials-steps-end


.. _campaign-adobe-customer-attributes-add:
...
.. campaign-adobe-customer-attributes-add-steps-start
...
.. campaign-adobe-customer-attributes-add-steps-end


.. _campaign-adobe-customer-attributes-workflow-actions:
...
.. campaign-adobe-customer-attributes-workflow-actions-start
...
.. campaign-adobe-customer-attributes-workflow-actions-end


.. _campaign-adobe-customer-attributes-workflow-actions-invalid-credentials:
...
.. _campaign-adobe-customer-attributes-workflow-actions-sftp-unavailable:
