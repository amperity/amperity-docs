...
.. |credential-type| replace:: "infutor"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Infutor.
...
.. destination-infutor-get-details-table-start
...
.. destination-infutor-get-details-table-end


.. _destination-infutor-credentials:
...
**To configure credentials for Infutor**

.. destination-infutor-credentials-steps-start
...
.. destination-infutor-credentials-steps-end


.. _destination-infutor-add:
...
**To add a destination for Infutor**

.. destination-infutor-add-steps-start
...
.. destination-infutor-add-steps-end
