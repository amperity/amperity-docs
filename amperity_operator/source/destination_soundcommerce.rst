...
.. |plugin-name| replace:: "SoundCommerce"
.. |credential-type| replace:: "sound-commerce"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to SoundCommerce.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for SoundCommerce
...
.. _destination-soundcommerce-get-details:
...
.. destination-soundcommerce-get-details-table-start
...
.. destination-soundcommerce-get-details-table-end


.. _destination-soundcommerce-credentials:
...
**To configure credentials for SoundCommerce**

.. destination-soundcommerce-credentials-steps-start
...
.. destination-soundcommerce-credentials-steps-end


.. _destination-soundcommerce-add:
...
**To add a destination for SoundCommerce**

.. destination-soundcommerce-add-steps-start
...
.. destination-soundcommerce-add-steps-end
