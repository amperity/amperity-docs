...
.. |credential-type| replace:: "blue-core"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Bluecore.
...
.. destination-bluecore-get-details-table-start
...
.. destination-bluecore-get-details-table-end


.. _destination-bluecore-credentials:
...
.. destination-bluecore-credentials-steps-start
...
.. destination-bluecore-credentials-steps-end


.. _destination-bluecore-add:
...
.. destination-bluecore-add-steps-start
...
.. destination-bluecore-add-steps-end
