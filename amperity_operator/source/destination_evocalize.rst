...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Evocalize
...
.. destination-evocalize-get-details-table-start
...
**To configure credentials for Evocalize**

.. destination-evocalize-credentials-steps-start
