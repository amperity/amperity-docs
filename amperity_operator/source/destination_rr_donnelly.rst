...
.. |plugin-name| replace:: "RR Donnelly"
.. |credential-type| replace:: "rr-donnelly"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to RR Donnelly.
...
.. _destination-rr-donnelly-get-details:
...
.. destination-rr-donnelly-get-details-table-start
...
.. destination-rr-donnelly-get-details-table-end


.. _destination-rr-donnelly-credentials:
...
**To configure credentials for RR Donnelly**

.. destination-rr-donnelly-credentials-steps-start
...
.. destination-rr-donnelly-credentials-steps-end


.. _destination-rr-donnelly-add:
...
**To add a destination for RR Donnelly**

.. destination-rr-donnelly-add-steps-start
...
.. destination-rr-donnelly-add-steps-end
