...
.. |source-name| replace:: Bluecore
.. |plugin-name| replace:: Bluecore
.. |feed-name| replace:: CustomerRecords
.. |example-filename| replace:: filename_YYYY-MM-DD.csv
.. |domain-table-name| replace:: |source-name|:|feed-name|
.. |credential-type| replace:: **bluecore**
.. |sftp-hostname| replace:: **files.bluecore.com** or **triggermail.exavault.com**
.. |what-pull| replace:: audience exports
.. |filter-the-list| replace:: "blu"


.. meta::
    :description lang=en:
        Configure Amperity to pull data from Bluecore.
...
.. source-bluecore-context-start

Pull email campaign data, such as email address, offer affinity, and lifetime value, and propensity metrics, such as opens, clicks, and unsubscribes, to Amperity.

.. source-bluecore-context-end

.. include:: ../../amperity_operator/source/source_sftp.rst
   :start-after: .. source-sftp-common-start
   :end-before: .. source-sftp-common-end

.. source-bluecore-steps-to-pull-start

.. include:: ../../shared/sources.rst
   :start-after: .. sources-overview-list-intro-start
   :end-before: .. sources-overview-list-intro-end

#. :ref:`Get details <source-bluecore-get-details>`
#. :ref:`Add data source <source-bluecore-add-data-source>`

.. source-bluecore-steps-to-pull-end


.. _source-bluecore-get-details:

Get details
==================================================

.. source-bluecore-get-details-start
...
.. source-bluecore-get-details-end


.. _source-bluecore-add-data-source:
...
**To add a data source for Bluecore**

.. source-bluecore-add-data-source-steps-start
...
.. source-bluecore-add-data-source-steps-end


.. _source-bluecore-workflow-actions:
...
.. source-bluecore-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`source-bluecore-workflow-actions-bad-archive`
       * :ref:`source-bluecore-workflow-actions-invalid-credentials`
       * :ref:`source-bluecore-workflow-actions-missing-file`
       * :ref:`source-bluecore-workflow-actions-sftp-unavailable`
       * :ref:`source-bluecore-workflow-actions-pgp-error`
       * :ref:`source-bluecore-workflow-actions-unable-to-decompress-archive`
...
.. source-bluecore-workflow-actions-end


.. _source-bluecore-workflow-actions-bad-archive:
...
.. _source-bluecore-workflow-actions-invalid-credentials:
...
.. _source-bluecore-workflow-actions-missing-file:
...
.. _source-bluecore-workflow-actions-pgp-error:
...
.. _source-bluecore-workflow-actions-sftp-unavailable:
...
.. _source-bluecore-workflow-actions-unable-to-decompress-archive:
