...
.. |credential-type| replace:: "adobe-customer-attributes"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Adobe Customer Attributes.
...
.. destination-adobe-customer-attributes-get-details-table-start
...
.. destination-adobe-customer-attributes-get-details-table-end


.. _destination-adobe-customer-attributes-credentials:
...
.. destination-adobe-customer-attributes-credentials-steps-start
...
.. destination-adobe-customer-attributes-credentials-steps-end


.. _destination-adobe-customer-attributes-add:
...
.. destination-adobe-customer-attributes-add-steps-start
...
.. destination-adobe-customer-attributes-add-steps-end
