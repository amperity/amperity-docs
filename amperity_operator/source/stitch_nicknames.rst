...
You can upload your files to extend the list of common nicknames to add and/or remove nicknames as needed for your tenant. You can use any file format -- |format_csv|, |format_json|, |format_psv|, |format_tsv|, |format_parquet|, etc. -- that is supported by Amperity. Stitch nicknames use a CSV file to describe how to manage nicknames.
