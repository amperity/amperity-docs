...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Acxiom.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destination for Acxiom

==================================================
Configure destination for Acxiom
==================================================

.. note:: This topic contains information about configuring a destination that sends query results to |destination-name| using orchestrations. To configure a destination that sends audiences to |destination-name| using campaigns see `this topic <https://docs.amperity.com/legacy/destination_acxiom.html>`__ |ext_link|.
...
.. destination-acxiom-get-details-table-start
...
.. destination-acxiom-get-details-table-end


.. _destination-acxiom-credentials:
...
**To configure credentials for Acxiom**

.. destination-acxiom-credentials-steps-start
...
.. destination-acxiom-credentials-steps-end


.. _destination-acxiom-add:
...
**To add a destination for Acxiom**

.. destination-acxiom-add-steps-start
...
.. destination-acxiom-add-steps-end
