...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to PowerReviews.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Send customer profiles to PowerReviews
...
.. destination-powerreviews-get-details-table-start
...
.. destination-powerreviews-get-details-table-end


.. _destination-powerreviews-credentials:
...
.. destination-powerreviews-credentials-steps-start
...
.. destination-powerreviews-credentials-steps-end


.. _destination-powerreviews-add:
...
.. destination-powerreviews-add-steps-start
...
.. destination-powerreviews-add-steps-end
