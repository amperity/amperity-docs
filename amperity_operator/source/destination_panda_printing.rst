...
.. meta::
    :description lang=en:
        Configure Amperity to send data to Panda Printing.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Panda Printing
...
.. _destination-panda-printing-get-details:
...
.. destination-panda-printing-get-details-table-start
...
.. destination-panda-printing-get-details-table-end


.. _destination-panda-printing-credentials:
...
.. destination-panda-printing-credentials-steps-start
...
.. destination-panda-printing-credentials-steps-end


.. _destination-panda-printing-add:
...
.. destination-panda-printing-add-steps-start
