...
.. meta::
    :description lang=en:
        Configure Amperity to pull data from Oracle Data Cloud.
...
.. source-oracle-data-cloud-steps-to-pull-start

.. include:: ../../shared/sources.rst
   :start-after: .. sources-overview-list-intro-start
   :end-before: .. sources-overview-list-intro-end

#. :ref:`Get details <source-oracle-data-cloud-get-details>`
#. :ref:`Add data source <source-oracle-data-cloud-add-data-source>`

.. source-oracle-data-cloud-steps-to-pull-end


.. _source-oracle-data-cloud-get-details:

Get details
==================================================

.. source-oracle-data-cloud-get-details-start
...
.. _source-oracle-data-cloud-add-data-source:

Add data source and feed
==================================================

.. source-oracle-data-cloud-add-data-source-intro-start-start
...
.. source-oracle-data-cloud-add-data-source-intro-end

**To add a data source for any SFTP site**

.. source-oracle-data-cloud-add-data-source-steps-start
...
.. source-oracle-data-cloud-add-data-source-steps-end


.. _source-oracle-data-cloud-workflow-actions:
...
.. source-oracle-data-cloud-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`source-oracle-data-cloud-workflow-actions-bad-archive`
       * :ref:`source-oracle-data-cloud-workflow-actions-invalid-credentials`
       * :ref:`source-oracle-data-cloud-workflow-actions-missing-file`
       * :ref:`source-oracle-data-cloud-workflow-actions-sftp-unavailable`
       * :ref:`source-oracle-data-cloud-workflow-actions-pgp-error`
       * :ref:`source-oracle-data-cloud-workflow-actions-unable-to-decompress-archive`
...
.. source-oracle-data-cloud-workflow-actions-end


.. _source-oracle-data-cloud-workflow-actions-bad-archive:
...
.. _source-oracle-data-cloud-workflow-actions-invalid-credentials:
...
.. _source-oracle-data-cloud-workflow-actions-missing-file:
...
.. _source-oracle-data-cloud-workflow-actions-pgp-error:
...
.. _source-oracle-data-cloud-workflow-actions-sftp-unavailable:
...
.. _source-oracle-data-cloud-workflow-actions-unable-to-decompress-archive:
