...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Epsilon Abacus.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Epsilon Abacus
...
.. _campaign-epsilon-abacus-get-details:
...
.. campaign-epsilon-abacus-get-details-table-start
...
.. campaign-epsilon-abacus-get-details-table-end


.. _campaign-epsilon-abacus-credentials:
...
.. campaign-epsilon-abacus-credentials-steps-start
...
.. campaign-epsilon-abacus-credentials-steps-end


.. _campaign-epsilon-abacus-add:
...
.. campaign-epsilon-abacus-add-steps-start
...
.. campaign-epsilon-abacus-add-steps-end
