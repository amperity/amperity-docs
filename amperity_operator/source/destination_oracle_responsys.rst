...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Oracle Responsys.
...
.. destination-oracle-responsys-get-details-table-start
...
.. destination-oracle-responsys-get-details-table-end


.. _destination-oracle-responsys-credentials:
...
**To configure credentials for Oracle Responsys**

.. destination-oracle-responsys-credentials-steps-start
...
.. destination-oracle-responsys-credentials-steps-end


.. _destination-oracle-responsys-add:
...
**To add a destination for Oracle Responsys**

.. destination-oracle-responsys-add-steps-start
...
.. destination-oracle-responsys-add-steps-end
