...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Experian.
...
.. destination-experian-get-details-table-start
...
.. destination-experian-get-details-table-end


.. _destination-experian-credentials:
...
.. destination-experian-credentials-steps-start
...
.. destination-experian-credentials-steps-end


.. _destination-experian-add:
...
.. destination-experian-add-steps-start
...
.. destination-experian-add-steps-end
