...
.. |credential-type| replace:: "oracle-data-cloud"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Oracle Data Cloud.
...
.. destination-oracle-data-cloud-get-details-table-start
...
.. destination-oracle-data-cloud-get-details-table-end


.. _destination-oracle-data-cloud-credentials:
...
**To configure credentials for Oracle Data Cloud**

.. destination-oracle-data-cloud-credentials-steps-start
...
.. destination-oracle-data-cloud-credentials-steps-end


.. _destination-oracle-data-cloud-add:
...
**To add a destination for Oracle Data Cloud**

.. destination-oracle-data-cloud-add-steps-start
...
.. destination-oracle-data-cloud-add-steps-end
