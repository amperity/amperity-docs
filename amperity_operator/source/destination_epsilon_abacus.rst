...
.. |plugin-name| replace:: "Epsilon Abacus"
.. |credential-type| replace:: "epsilon-abacus"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Epsilon Abacus.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Epsilon Abacus
...
.. _destination-epsilon-abacus-get-details:
...
.. destination-epsilon-abacus-get-details-table-start
...
.. destination-epsilon-abacus-get-details-table-end


.. _destination-epsilon-abacus-credentials:
...
.. destination-epsilon-abacus-credentials-steps-start
...
.. destination-epsilon-abacus-credentials-steps-end


.. _destination-epsilon-abacus-add:
...
.. destination-epsilon-abacus-add-steps-start
...
.. destination-epsilon-abacus-add-steps-end
