...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Epsilon Targeting.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Epsilon Targeting
...
.. _campaign-epsilon-targeting-get-details:
...
.. campaign-epsilon-targeting-get-details-table-start
...
.. campaign-epsilon-targeting-get-details-table-end


.. _campaign-epsilon-targeting-credentials:
...
.. campaign-epsilon-targeting-credentials-steps-start
...
.. campaign-epsilon-targeting-credentials-steps-end


.. _campaign-epsilon-targeting-add:
...
.. campaign-epsilon-targeting-add-steps-start
...
.. campaign-epsilon-targeting-add-steps-end
