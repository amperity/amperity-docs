...
.. list-table::
   ...
   * - .. image:: ../../images/steps-02.png
          ...
          :align: left
          :class: no-scaled-link
     - Send an Apache Parquet, Apache Avro, CSV, or JSON file to `Databricks <https://docs.amperity.com/operator/bridge_databricks.html>`__ |ext_link| as a Delta table from Amperity.
