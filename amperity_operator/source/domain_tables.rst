...
The **Domain Tables** section of the **Sources** page lists the domain tables that have been generated by feeds. Each row shows the name of the domain table, the type of record contained within that domain table, and the number of columns.
...
Amperity adds the following columns to all domain tables. Each column starts with an underscore.

   #. The **_pk** column is an identifier generated from all of the columns in the feed that are associated to the primary key.
   #. The **_uuid_pk** column is a system-generated UUID. This UUID helps Amperity distribute work during Stitch processing.
   #. The **_updated** column has details about the last update and is system-generated.

   These columns are available from passthrough tables in the customer 360 database.
