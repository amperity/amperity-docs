...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Monetate.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Monetate
...
.. destination-monetate-get-details-table-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-check-off-black.png
          ...
          :align: center
          :class: no-scaled-link
     - **Monetate requirements**

       .. include:: ../../amperity_user/source/destination_monetate.rst
          :start-after: .. destination-monetate-get-details-note-start
          :end-before: .. destination-monetate-get-details-note-end 

.. destination-monetate-get-details-table-end


.. _destination-monetate-credentials:
...
.. destination-monetate-credentials-steps-start
...
.. destination-monetate-credentials-steps-end


.. _destination-monetate-add:
...
.. destination-monetate-add-steps-start
...
.. destination-monetate-add-steps-end
