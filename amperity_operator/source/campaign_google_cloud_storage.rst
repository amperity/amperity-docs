...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to an Google Cloud Storage bucket.
...
.. _campaign-google-cloud-storage-get-details:
...
.. campaign-google-cloud-storage-get-details-table-start
...
.. campaign-google-cloud-storage-get-details-table-end


.. _campaign-google-cloud-storage-credentials:
...
.. campaign-google-cloud-storage-credentials-connection-string-steps-start
...
.. campaign-google-cloud-storage-credentials-connection-string-steps-end



.. _campaign-google-cloud-storage-service-accounts:

About service accounts
--------------------------------------------------

.. campaign-google-cloud-storage-service-accounts-start
...
.. campaign-google-cloud-storage-service-accounts-end


.. _campaign-google-cloud-storage-service-account-key:

Service account key
++++++++++++++++++++++++++++++++++++++++++++++++++

.. campaign-google-cloud-storage-service-account-key-start

A service account key must be downloaded so that it may be used to configure the destination in Amperity.

.. campaign-google-cloud-storage-service-account-key-end

**To configure the service account key**

.. campaign-google-cloud-storage-service-account-key-steps-start
...
.. campaign-google-cloud-storage-service-account-key-steps-end

.. _campaign-google-cloud-storage-service-account-key-example:

**Example**

.. campaign-google-cloud-storage-service-account-key-example-start
...
.. campaign-google-cloud-storage-service-account-key-example-end


.. _campaign-google-cloud-storage-service-account-role:

Service account role
++++++++++++++++++++++++++++++++++++++++++++++++++

.. campaign-google-cloud-storage-service-account-role-start

The **Storage Object Admin** role must be assigned to the service account.

.. campaign-google-cloud-storage-service-account-role-end

**To configure the service account role**

.. campaign-google-cloud-storage-service-account-role-steps-start
...
.. campaign-google-cloud-storage-service-account-role-steps-end


.. _campaign-google-cloud-storage-add:
...
.. campaign-google-cloud-storage-add-steps-start
...
.. campaign-google-cloud-storage-add-steps-end


.. _campaign-google-cloud-storage-workflow-actions:
...
.. campaign-google-cloud-storage-workflow-actions-end


.. _campaign-google-cloud-storage-workflow-actions-invalid-credentials:
