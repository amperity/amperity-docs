...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to LinkedIn DMP.
...
.. campaign-linkedin-dmp-api-note-end


.. _campaign-linkedin-dmp-get-details:
...
.. campaign-linkedin-dmp-get-details-table-start
...
.. campaign-linkedin-dmp-credentials-steps-start
...
.. campaign-linkedin-dmp-credentials-steps-end


.. _campaign-linkedin-dmp-reauthorize-amperity:
...
.. campaign-linkedin-dmp-add-steps-start
...
.. campaign-linkedin-dmp-add-steps-end


.. _campaign-linkedin-dmp-workflow-actions:
...
.. campaign-linkedin-dmp-workflow-actions-end


.. _campaign-linkedin-dmp-workflow-actions-dataset-size-error:

Dataset size error
--------------------------------------------------

.. campaign-linkedin-dmp-workflow-actions-dataset-size error-start

|destination-name| requires the uploaded audience to be between 300 and 300,000 rows.

.. campaign-linkedin-dmp-workflow-actions-dataset-size error-end

.. campaign-linkedin-dmp-workflow-actions-dataset-size error-steps-start
...
.. campaign-linkedin-dmp-workflow-actions-dataset-size error-steps-end

.. _campaign-linkedin-dmp-workflow-actions-invalid-account-id:
...
.. campaign-linkedin-dmp-workflow-actions-invalid-account-id-steps-start
...
.. campaign-linkedin-dmp-workflow-actions-invalid-account-id-steps-end


.. _campaign-linkedin-dmp-workflow-actions-invalid-fields:
...
.. _campaign-linkedin-dmp-workflow-actions-linkedin-is-processing-data:

LinkedIn is processing data
--------------------------------------------------

.. campaign-linkedin-dmp-workflow-actions-linkedin-is-processing-data-start
...
.. campaign-linkedin-dmp-workflow-actions-linkedin-is-processing-data-end

.. campaign-linkedin-dmp-workflow-actions-linkedin-is-processing-data-steps-start
...
.. campaign-linkedin-dmp-workflow-actions-linkedin-is-processing-data-steps-end
