...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Vibes.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Send customer profiles to Vibes

==================================================
Send customer profiles to Vibes
==================================================

.. note:: This topic contains information about configuring a destination that sends query results to |destination-name| using orchestrations. To configure a destination that sends audiences to |destination-name| using campaigns see `this topic <https://docs.amperity.com/legacy/destination_vibes.html>`__ |ext_link|.
...
.. destination-vibes-get-details-table-start
...
.. destination-vibes-get-details-table-end


.. _destination-vibes-credentials:
...
.. destination-vibes-credentials-steps-start
...
.. destination-vibes-credentials-steps-end


.. _destination-vibes-add:
...
.. destination-vibes-add-steps-start
...
.. destination-vibes-add-steps-end
