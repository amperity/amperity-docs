...
.. |what-send| replace:: CSV or JSON files
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Domo
...
**To add a destination for Domo**

.. destination-domo-add-steps-start
...
.. destination-domo-add-steps-end
