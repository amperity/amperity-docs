...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Neustar.

.. meta::
    :content class=swiftype name=body data-type=text:
        Configure Amperity to send campaigns data to Neustar.
...
.. campaign-neustar-get-details-table-start
...
.. campaign-neustar-get-details-table-end


.. _campaign-neustar-credentials:
...
.. campaign-neustar-credentials-steps-start
...
.. campaign-neustar-credentials-steps-end


.. _campaign-neustar-add:
...
.. campaign-neustar-add-steps-start
...
.. campaign-neustar-add-steps-end


.. _campaign-neustar-workflow-actions:
...
.. campaign-neustar-workflow-actions-start
...
.. campaign-neustar-workflow-actions-end


.. _campaign-neustar-workflow-actions-invalid-credentials:
...
.. _campaign-neustar-workflow-actions-sftp-unavailable:
