...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Camelot SMM.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Camelot SMM
...
.. _campaign-camelot-smm-get-details:
...
.. campaign-camelot-smm-get-details-table-start
...
.. campaign-camelot-smm-get-details-table-end


.. _campaign-camelot-smm-credentials:
...
.. campaign-camelot-smm-credentials-steps-start
...
.. campaign-camelot-smm-credentials-steps-end


.. _campaign-camelot-smm-add:
...
.. campaign-camelot-smm-add-steps-start
