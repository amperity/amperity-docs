...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to SoundCommerce.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for SoundCommerce
...
.. _campaign-soundcommerce-get-details:
...
.. campaign-soundcommerce-get-details-table-start
...
.. campaign-soundcommerce-get-details-table-end


.. _campaign-soundcommerce-credentials:
...
.. campaign-soundcommerce-credentials-steps-start
...
.. campaign-soundcommerce-credentials-steps-end


.. _campaign-soundcommerce-add:
...
.. campaign-soundcommerce-add-steps-start
...
.. campaign-soundcommerce-add-steps-end
