...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Epsilon Conversant.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Epsilon Conversant
...
.. _destination-epsilon-conversant-get-details:
...
.. destination-epsilon-conversant-get-details-table-start
...
.. _destination-epsilon-conversant-credentials:
...
.. destination-epsilon-conversant-credentials-steps-start
...
.. destination-epsilon-conversant-credentials-steps-end


.. _destination-epsilon-conversant-add:
...
.. destination-epsilon-conversant-add-steps-start
...
.. destination-epsilon-conversant-add-steps-end
