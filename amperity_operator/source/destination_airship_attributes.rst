...
.. meta::
    :description lang=en:
        Configure Amperity to send data to Airship Attributes.
...
.. destination-airship-attributes-api-note-start
...
.. destination-airship-attributes-api-note-end

.. destination-airship-attributes-beta-start

.. admonition:: Beta

   The Airship Attributes connector is currently in beta. Contact your Amperity representative to learn more.

.. destination-airship-attributes-beta-end

.. destination-airship-attributes-behavior-start
...
.. _destination-airship-attributes-get-details:
...
.. destination-airship-attributes-get-details-table-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-check-off-black.png
          ...
          :align: center
          :class: no-scaled-link
     - A query that outputs the fields to send to |destination-name|. The **airship_identifier** field is required. Each additional field is sent as an Airship attribute and must already exist as an attribute in your Airship project.

.. destination-airship-attributes-get-details-end


.. _destination-airship-attributes-credentials:
...
.. destination-airship-attributes-credentials-steps-start
...
.. destination-airship-attributes-credentials-steps-end


.. _destination-airship-attributes-add:
...
.. destination-airship-attributes-add-steps-start
...
.. destination-airship-attributes-add-steps-end
