...
.. |credential-type| replace:: "pebble-post"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to PebblePost.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for PebblePost
...
.. destination-pebblepost-get-details-table-start
...
.. destination-pebblepost-get-details-table-end


.. _destination-pebblepost-credentials:
...
**To configure credentials for PebblePost**

.. destination-pebblepost-credentials-steps-start
...
.. destination-pebblepost-credentials-steps-end


.. _destination-pebblepost-add:
...
**To add a destination for PebblePost**

.. destination-pebblepost-add-steps-start
...
.. destination-pebblepost-add-steps-end
