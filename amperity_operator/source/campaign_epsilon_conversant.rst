...
.. |destination-name| replace:: Epsilon Conversant
.. |plugin-name| replace:: "Epsilon Conversant"
.. |credential-type| replace:: "epsilon-conversant"
.. |required-credentials| replace:: "username", "hostname", and "passphrase"
.. |what-send| replace:: CSV files
.. |where-send| replace:: |destination-name|
.. |sftp-hostname| replace:: "[value].epsilon.com"
...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Epsilon Conversant.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Epsilon Conversant
...
.. _campaign-epsilon-conversant-get-details:
...
.. campaign-epsilon-conversant-get-details-table-start
...
.. campaign-epsilon-conversant-get-details-table-end


.. _campaign-epsilon-conversant-credentials:
...
**To configure credentials for Epsilon Conversant**

.. campaign-epsilon-conversant-credentials-steps-start
...
.. campaign-epsilon-conversant-credentials-steps-end


.. _campaign-epsilon-conversant-add:
...
**To add a destination for Epsilon Conversant**

.. campaign-epsilon-conversant-add-steps-start
...
.. campaign-epsilon-conversant-add-steps-end
