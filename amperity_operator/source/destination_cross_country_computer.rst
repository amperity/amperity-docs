...
.. |plugin-name| replace:: "Cross Country Computer"
.. |credential-type| replace:: "cross-country-computer"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Cross Country Computer.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Cross Country Computer
...
.. _destination-cross-country-computer-get-details:
...
.. destination-cross-country-computer-get-details-table-start
...
.. destination-cross-country-computer-get-details-table-end


.. _destination-cross-country-computer-credentials:
...
**To configure credentials for Cross Country Computer**

.. destination-cross-country-computer-credentials-steps-start
...
.. destination-cross-country-computer-credentials-steps-end


.. _destination-cross-country-computer-add:
...
**To add a destination for Cross Country Computer**

.. destination-cross-country-computer-add-steps-start
...
.. destination-cross-country-computer-add-steps-end
