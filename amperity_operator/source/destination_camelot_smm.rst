...
.. |destination-name| replace:: Camelot SMM
.. |plugin-name| replace:: "Camelot SMM"
.. |credential-type| replace:: "camelot-smm"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Camelot SMM.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Camelot SMM
...
.. _destination-camelot-smm-get-details:
...
.. destination-camelot-smm-get-details-table-start
...
.. destination-camelot-smm-get-details-table-end


.. _destination-camelot-smm-credentials:
...
**To configure credentials for Camelot SMM**

.. destination-camelot-smm-credentials-steps-start
...
.. destination-camelot-smm-credentials-steps-end


.. _destination-camelot-smm-add:
...
**To add a destination for Camelot SMM**

.. destination-camelot-smm-add-steps-start
...
.. destination-camelot-smm-add-steps-end
