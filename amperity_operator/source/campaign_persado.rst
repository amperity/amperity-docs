...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Persado.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for Persado
...
.. campaign-persado-get-details-table-start
...
.. campaign-persado-get-details-table-end


.. _campaign-persado-credentials:
...
.. campaign-persado-credentials-steps-start
...
.. campaign-persado-credentials-steps-end


.. _campaign-persado-add:
...
.. campaign-persado-add-steps-start
...
.. campaign-persado-add-steps-end


.. _campaign-persado-workflow-actions:
...
.. campaign-persado-workflow-actions-start
...
.. campaign-persado-workflow-actions-end


.. _campaign-persado-workflow-actions-invalid-credentials:
...
.. _campaign-persado-workflow-actions-sftp-unavailable:
