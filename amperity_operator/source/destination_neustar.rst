...
.. |credential-type| replace:: "neustar"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Neustar.

.. meta::
    :content class=swiftype name=body data-type=text:
        Configure Amperity to send customer profiles data to Neustar.

.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destination for Neustar

==================================================
Configure destination for Neustar
==================================================

.. note:: This topic contains information about configuring a destination that sends query results to |destination-name| using orchestrations. To configure a destination that sends audiences to |destination-name| using campaigns see `this topic <https://docs.amperity.com/legacy/destination_neustar.html>`__ |ext_link|.
...
.. destination-neustar-get-details-table-start
...
.. destination-neustar-get-details-table-end


.. _destination-neustar-credentials:
...
**To configure credentials for Neustar**

.. destination-neustar-credentials-steps-start
...
.. destination-neustar-credentials-steps-end


.. _destination-neustar-add:
...
**To add a destination for Neustar**

.. destination-neustar-add-steps-start
...
.. destination-neustar-add-steps-end
