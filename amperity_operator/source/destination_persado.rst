...
.. |plugin-name| replace:: "Persado"
.. |credential-type| replace:: "persado"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to Persado.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure destinations for Persado
...
.. destination-persado-about-eu-note-start
...
.. destination-persado-about-eu-note-end
...
.. destination-persado-get-details-table-start
...
.. destination-persado-get-details-table-end


.. _destination-persado-credentials:
...
**To configure credentials for Persado**

.. destination-persado-credentials-steps-start
...
.. destination-persado-credentials-steps-end


.. _destination-persado-add:
...
**To add a destination for Persado**

.. destination-persado-add-steps-start
...
.. destination-persado-add-steps-end
