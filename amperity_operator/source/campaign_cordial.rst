...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to Cordial.
...
.. campaign-cordial-get-details-alternate-note-start
...
.. campaign-cordial-get-details-alternate-note-end


.. _campaign-cordial-get-details:
...
.. campaign-cordial-get-details-table-start
...
.. campaign-cordial-get-details-end


.. _campaign-cordial-credentials:
...
.. campaign-cordial-credentials-steps-start
...
.. campaign-cordial-credentials-steps-end


.. _campaign-cordial-add:
...
.. campaign-cordial-add-steps-start
...
.. campaign-cordial-add-steps-end


.. _campaign-cordial-workflow-actions:
...
.. campaign-cordial-workflow-actions-start
...
.. campaign-cordial-workflow-actions-end


.. _campaign-cordial-workflow-actions-invalid-credentials:
...
.. _campaign-cordial-workflow-actions-required-attributes-missing:

Required attributes are missing
--------------------------------------------------

.. campaign-cordial-workflow-actions-required-attributes-missing-start

|destination-name| will reject audiences when required attributes are missing.

.. campaign-cordial-workflow-actions-required-attributes-missing-end

**For campaigns**

.. campaign-cordial-workflow-actions-required-attributes-missing-campaigns-steps-start
...
.. campaign-cordial-workflow-actions-required-attributes-missing-orchestrations-steps-start
...
.. _campaign-cordial-workflow-actions-unique-list-name-required:

Unique list name required
--------------------------------------------------

.. campaign-cordial-workflow-actions-unique-list-name-required-start
...
.. campaign-cordial-workflow-actions-unique-list-name-required-end
