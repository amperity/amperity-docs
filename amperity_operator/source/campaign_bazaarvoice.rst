...
.. meta::
    :description lang=en:
        Configure Amperity to send campaigns to BazaarVoice.
...
.. meta::
    :content class=swiftype name=title data-type=string:
        Configure campaigns for BazaarVoice
...
.. _campaign-bazaarvoice-get-details:
...
.. campaign-bazaarvoice-get-details-table-start
   ...
   * - .. image:: ../../images/steps-check-off-black.png
     ...
     - **Required configuration settings**
       ...
       **File format**
          ...
          .. admonition:: Recommendations for file formats
...
.. campaign-bazaarvoice-get-details-table-end


.. _campaign-bazaarvoice-credentials:
...
**To configure credentials for BazaarVoice**

.. campaign-bazaarvoice-credentials-steps-start
...
.. campaign-bazaarvoice-credentials-steps-end


.. _campaign-bazaarvoice-add:
...
**To add a destination for BazaarVoice**

.. campaign-bazaarvoice-add-steps-start
...
.. campaign-bazaarvoice-add-steps-end


.. _campaign-bazaarvoice-workflow-actions:
...
.. campaign-bazaarvoice-workflow-actions-start
...
.. campaign-bazaarvoice-workflow-actions-end


.. _campaign-bazaarvoice-workflow-actions-invalid-credentials:
...
.. _campaign-bazaarvoice-workflow-actions-sftp-unavailable:
