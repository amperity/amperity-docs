...
.. list-table::
   ...
   * - **401 Authentication Required**
     - A request contains invalid authentication or an expired token.

   * - **403 Not Authorized**
     - A request contains valid authentication, but does not have permission to perform the requested action.
   ...
   * - **429 Too Many Requests**
     - The rate limit has been exceeded. See :doc:`Rate limits <rate_limits>` for details.

       .. tip:: Watch for 429 error codes and build a retry mechanism into integrations or applications. Use an exponential backoff schedule with some randomness built in to reduce request volume.
