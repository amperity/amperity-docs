...
Use the "Truncate and load" option to delete all rows in the associated domain table before loading data. Use the "Load" option to load data from the selected file to the associated domain table.
