...
.. _start-here-customer360:

Customer 360 database
==================================================

.. start-here-customer360-start
...
.. start-here-customer360-end


.. _start-here-flexible-merge-rules:

Flexible merge rules
--------------------------------------------------

.. start-here-flexible-merge-rules-start
...
.. start-here-flexible-merge-rules-end


.. _start-here-customer-profiles:
...
.. start-here-data-model-table-types-start
...
.. start-here-data-model-table-types-end


.. _start-here-data-model-indicators:
...
.. _start-here-queries-tab:

Queries
==================================================

.. start-here-queries-tab-start
...
.. start-here-queries-tab-sql-interfaces-end


.. _start-here-query-editor:
...
.. _start-here-send-to-downstream-workflows:

Send to downstream workflows
==================================================

.. start-here-send-to-downstream-workflows-start
...
.. start-here-send-to-downstream-workflows-end


.. _start-here-export-databases-and-tables:
...
.. _start-here-sync-with-data-lakehouses:
