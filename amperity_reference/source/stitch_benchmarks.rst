...
.. meta::
    :description lang=en:
        Benchmarks are heuristic scores that define the expectations for the quality of customer profiles that are output by Stitch.
...
.. stitch-benchmarks-common-start
...
.. stitch-benchmarks-status-start
...
* Red indicates that :ref:`results are high <stitch-benchmarks-results-high>`.
* Orange indicates that :ref:`results are above the optimal range <stitch-benchmarks-results-above-optimal>`.
* Green indicates that :ref:`results fall within the optimal range <stitch-benchmarks-results-optimal>`.

For each benchmark check on the **Benchmarks** tab you can click to open the benchmark, and :ref:`explore details <stitch-benchmarks-cards-details>`, the :ref:`previous five benchmark scores <stitch-benchmarks-cards-history>`, :ref:`interpretations <stitch-benchmarks-cards-interpretations>`, and a link to open a dialog box from which you can :ref:`review and grade a representative sample <stitch-benchmarks-cards-grade-and-calibrate>` of 10 examples.

.. stitch-benchmarks-status-end
...
.. stitch-benchmarks-checks-start
...
.. stitch-benchmarks-checks-end

.. stitch-benchmarks-checks-important-start
...
.. stitch-benchmarks-checks-important-end
...
.. stitch-benchmarks-results-start
...
* :ref:`Optimal <stitch-benchmarks-results-optimal>`
* :ref:`Above optimal range <stitch-benchmarks-results-above-optimal>`
* :ref:`High <stitch-benchmarks-results-high>`

.. stitch-benchmarks-results-end
...
.. stitch-benchmarks-results-optimal-start
...
.. stitch-benchmarks-results-optimal-end
...
.. stitch-benchmarks-results-above-optimal-start
...
.. stitch-benchmarks-results-above-optimal-end
...
.. stitch-benchmarks-results-high-start
...
.. stitch-benchmarks-results-high-end
...
.. stitch-benchmarks-cards-details-start
...
.. stitch-benchmarks-cards-details-end
...
.. stitch-benchmarks-cards-history-start
...
.. stitch-benchmarks-cards-history-end
...
.. stitch-benchmarks-cards-interpretations-start
...
.. stitch-benchmarks-cards-interpretations-end
...
.. stitch-benchmarks-cards-grade-and-calibrate-start
...
.. stitch-benchmarks-cards-grade-and-calibrate-howitworks-start
...
.. stitch-benchmarks-cards-grade-and-calibrate-howitworks-end
...
.. stitch-benchmarks-check-update-config-start
...
.. stitch-benchmarks-categories-start

The following sections list benchmark checks by category:

* :ref:`stitch-benchmarks-category-overclustering`
* :ref:`stitch-benchmarks-category-underclustering`

.. stitch-benchmarks-categories-end
...
.. stitch-benchmarks-category-overclustering-start
...
.. stitch-benchmarks-category-overclustering-end
...
.. stitch-benchmarks-category-many-given-names-start
...
.. stitch-benchmarks-category-many-given-names-end
...
.. stitch-benchmarks-category-many-postal-codes-start
...
.. stitch-benchmarks-category-many-postal-codes-end
...
.. stitch-benchmarks-category-many-surnames-start
...
.. stitch-benchmarks-category-many-surnames-end
...
.. stitch-benchmarks-category-underclustering-start
...
.. stitch-benchmarks-category-underclustering-end
...
.. stitch-benchmarks-category-shared-names-and-emails-start
...
.. stitch-benchmarks-category-shared-names-and-emails-end
...
.. stitch-benchmarks-category-shared-names-and-phones-start
...
.. stitch-benchmarks-category-shared-names-and-phones-end
...
.. stitch-benchmarks-category-shared-names-and-addresses-start
...
.. stitch-benchmarks-category-shared-names-and-addresses-end
