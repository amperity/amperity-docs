...
Amperity supports the following data types when structured data is made available to Amperity. Complex types--**array**, **map**, and **struct**--must be converted to individual fields before making them available to the Stitch process.
