...
You can access if an order was canceled directly from the **Segment Editor**. To add this attribute to your segment, click **Add criteria**, select the **Unified Itemized Transactions** table, select the **Is Cancellation** attribute, and then apply a condition.
