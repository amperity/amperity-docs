...
.. attribute-is-canceled-start

You can access if an order was canceled directly from the **Segment Editor**. To add this attribute to your segment, To add these attributes to your segment, click **Add condition** and then **Add attribute**. Select the **Unified Itemized Transactions** table, select the **Is Cancellation** attribute, and then apply a condition.

.. attribute-is-canceled-end
