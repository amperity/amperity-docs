...
You can access first-to-latest order days directly from the **Segment Editor**. To add this attribute to your segment, click **Add criteria**, select the **Transaction Attributes Extended** table, select the **First To Latest Order Days** attribute, apply a condition, and then specify a value.
