...
.. meta::
    :description lang=en:
        Predict customer behavior, such as customer lifetime value, churn propensity, product affinity, and lifecycle events.
...
.. grid-attributes-predictive-about-start

Predict customer behavior, such as customer lifetime value, churn propensity, product affinity, and lifecycle events.

.. grid-attributes-predictive-about-end

.. grid-attributes-predictive-grid-start
