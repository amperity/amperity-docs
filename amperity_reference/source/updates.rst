...
**Destination topics**
   ...
   :bdg-success:`NEW` New destinations for `Google Analytics 4 <../operator/destination_google_analytics.html>`__, `Oracle Emarsys <../operator/destination_sap_emarsys.html>`__, and `Tulip <../operator/destination_tulip.html>`__.
