...
.. note:: All users can access `sandboxes <https://docs.amperity.com/operator/sandboxes.html>`__ they have access to in their tenant from the dropdown menu in the top-right corner of the Amperity platform.
