...
.. include:: ../../amperity_reference/source/journeys.rst
   :start-after: .. journeys-howtos-set-run-frequency-start
   :end-before: .. journeys-howtos-set-run-frequency-end

.. include:: ../../amperity_reference/source/journeys.rst
   :start-after: .. journeys-howtos-set-run-frequency-note-start
   :end-before: .. journeys-howtos-set-run-frequency-note-end

**To set the run frequency for a journey**

.. include:: ../../amperity_reference/source/journeys.rst
   :start-after: .. journeys-howtos-set-run-frequency-steps-start
   :end-before: .. journeys-howtos-set-run-frequency-end
