...
.. paid-media-destinations-tables-start
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-amazon-ads.png
          :width: 140 px
          :alt: Amazon Ads
          :align: left
          :class: no-scaled-link
     - |destination_amazon_ads| is an online advertising platform that helps to target customers, track campaign results, and improve brand awareness.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-bing-ads.png
          :width: 140 px
          :alt: Bing
          :align: left
          :class: no-scaled-link
     - Bing Ads appear within the Bing advertising network to web users. Advertisers pay to display brief advertisements, service offerings, product listings, and so on. Use the |channel_microsoft_ads| destination to advertise to audiences across the Bing advertising networks.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-google-display-video.png
          :width: 140 px
          :alt: Display & Video 360
          :align: left
          :class: no-scaled-link
     - Display & Video 360 enables advertising on connected TVs (CTVs), such as Android TV and Chromecast, online video platforms, such as YouTube, along with access to third-party partner exchanges. Use the |channel_google_dv360| destination to activate audiences using Display & Video 360.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-facebook-ads.svg
          ...
          :align: left
          :class: no-scaled-link
     - Ads on Facebook appear in a variety of locations, including the news feed and within the right-side column on pages. Use |channel_meta_ads_manager| to manage ad placements on Facebook.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-facebook-messenger.svg
          ...
          :align: left
          :class: no-scaled-link
     - Facebook Messenger is a mobile app for chat, messaging, and video that integrates seamlessly with Instagram and Facebook. Use |channel_meta_ads_manager| to reach users on Facebook Messenger.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-google-gmail.png
          :width: 140 px
          :alt: Gmail
          :align: left
          :class: no-scaled-link
     - Gmail is a web-based email platform that supports inline paid media advertising. Use the |channel_google_ads| destination to activate audiences using Gmail.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-google-ads.svg
          ...
          :align: left
          :class: no-scaled-link
     - Google Ads appear within the Google advertising network to web users. Use ads to promote your brand, help sell products or services, raise awareness, and increase traffic to your website or stores. Use the |channel_google_ads| destination to activate audiences using Google Ads.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-google-search.png
          :width: 140 px
          :alt: Google Search
          :align: left
          :class: no-scaled-link
     - Google Search ads enable paid media advertising at the top of search results on Google.com. Use the |channel_google_ads| destination to activate audiences using Google Search.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-google-shopping.png
          :width: 140 px
          :alt: Google Shopping
          :align: left
          :class: no-scaled-link
     - Google Shopping ads enable paid media advertising from the Shopping tab on Google.com. Use the |channel_google_ads| destination to activate audiences using Google Shopping.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-instagram.svg
          ...
          :align: left
          :class: no-scaled-link
     - Instagram is photo and video sharing mobile app on which your brand can use images, videos, and links to promote your brand’s products and services. Use the |channel_meta_ads_manager| destination to reach users on Instagram.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-liveramp.svg
          :width: 140 px
          :alt: LiveRamp
          :align: left
          :class: no-scaled-link
     - Send audiences to |channel_liveramp| from Amperity, and then use your combined online and offline data sources to build personalized omnichannel experiences that grow revenue and build better long-term relationships with your customers.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-meta.svg
          ...
          :align: left
          :class: no-scaled-link
     - |channel_meta_ads_manager| is a unified ad creation tool that your brand can use to create and publish ads to Facebook, Messenger, Instagram and the Meta Audience Network. When you send data to Facebook using the Facebook Ads destination, your data will be available from Meta Ads Manager.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-neustar.svg
          :width: 140 px
          :alt: Neustar
          :align: left
          :class: no-scaled-link
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-pinterest.png
     ...
     - Pinterest is a visual discovery engine on which your brand can engage with your customers. Send a list of products that are in your product catalog to Pinterest to enable pins, and then send a list of customers with whom your brand wants to engage.
       ...
       Build audiences in Amperity, and then upload those audiences to |channel_pinterest|.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-thetradedesk.png
          ...
          :align: left
          :class: no-scaled-link
     - The Trade Desk is a platform for wide internet advertising and enables the use of UID 2.0 for first-party paid media advertising. Send your best audiences from Amperity to the |channel_the_trade_desk| , and then reach audiences across connected TVs, live sporting events, and advertising platforms like Disney Advertising (Disney+, Hulu, ESPN), Paramount Advertising, and more.
...
.. list-table::
   ...
   * - .. image:: ../../amperity_base/source/_static/connector-tiktok.png
          ...
          :align: left
          :class: no-scaled-link
     - TikTok is the world’s leading destination for short-form mobile videos. TikTok’s mission is to capture and present the world’s creativity, knowledge, and moments that matter in everyday life. Send audiences to |channel_tiktok| directly from Amperity.
