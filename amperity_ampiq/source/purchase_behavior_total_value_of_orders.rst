...
.. include:: ../../amperity_reference/source/attribute_compound_total_value_of_orders.rst
   :start-after: .. attribute-compound-total-value-of-orders-start
   :end-before: .. attribute-compound-total-value-of-orders-end
...
.. include:: ../../amperity_reference/source/attribute_compound_total_value_of_orders.rst
   :start-after: .. attribute-compound-total-value-of-orders-howitworks-start
   :end-before: .. attribute-compound-total-value-of-orders-howitworks-end

.. segments-behaviors-total-value-of-orders-tip-start

.. tip:: For more information about how **Total Value of Orders** works, including an explanation of the SQL that runs behind the **Segment Editor**, review the |attribute_compound_total_value_of_orders| topic in the Amperity A-Z reference.
...
.. include:: ../../amperity_reference/source/attribute_compound_total_value_of_orders.rst
   :start-after: .. attribute-compound-total-value-of-orders-segments-start
   :end-before: .. attribute-compound-total-value-of-orders-segments-end
...
.. include:: ../../amperity_reference/source/attribute_compound_total_value_of_orders.rst
   :start-after: .. attribute-compound-total-value-of-orders-segments-filters-start
   :end-before: .. attribute-compound-total-value-of-orders-segments-filters-end
...
.. image:: ../../images/attribute-compound-total-value-of-orders-example-segments.png
   :width: 600 px
   :alt: All orders with shoes
   :align: left
   :class: no-scaled-link
