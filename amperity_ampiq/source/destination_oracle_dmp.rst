...
.. meta::
    :description lang=en:
        Use segments and campaigns to send audiences from Amperity to Oracle DMP.
...
.. _channel-oracle-dmp-build-segment:
...
.. _channel-oracle-dmp-build-campaign:
