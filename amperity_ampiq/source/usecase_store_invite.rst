...
.. list-table::
   ...
   * - .. image:: ../../images/steps-02.png
     ...
     - The first step is to identify customers for whom your brand has complete and contactable phone numbers in their customer profiles. Choose the **Contactable Phone** attribute from the **Customer Attributes** table, and then select the "is true" operator:
       ...
       Set the and/or slider set to **AND**.
   ...
   * - .. image:: ../../images/steps-05.png
          ...
          :align: left
          :class: no-scaled-link
     - You're done building your audience! Click the **Save As** button in the top right corner of the **Segment Editor**. Give your segment a name that clearly describes the purpose and audience type for the segment. For example: "In-store Customers"
