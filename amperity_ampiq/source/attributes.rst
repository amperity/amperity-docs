...
Some audience attributes represent consolidated views of your customers, while others are based on predictive modeling and other calculations that are part of AmpIQ and provide a series of specific attributes that you can use to define high-value segments for use with downstream campaigns.
