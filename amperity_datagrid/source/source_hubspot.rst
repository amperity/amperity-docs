...
.. |source-interface| replace:: the |ext_hubspot_api|
...
#. Permission to sychronize FiveTran to HubSpot. This must be done by a user of HubSpot with |ext_hubspot_super_admin|. (Log into HubSpot as a user with **Super Admin** privileges, select the account you want to synchronize, click **Grant Access**, and then click **Save & Test**.)
