...
.. TODO: We will want to update to be closer to this section: https://docs.amperity.com/datagrid/api_streaming_ingest.html#api-keys-and-jwts after we have the self-service access token feature in-place.
...
You can use the Profile API to make extended profile attributes available to Braze using |ext_braze_connected_content|.
