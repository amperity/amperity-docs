...
.. |sendto-link| replace:: |sendto_evocalize|
...
#. :ref:`Add data template <destination-evocalize-add-data-template>`
...
.. destination-evocalize-get-details-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-check-off-black.png
          ...
          :align: left
          :class: no-scaled-link
     - The public key to use for PGP encryption, if enabled.
...
.. destination-evocalize-add-destination-steps-start
...
.. destination-evocalize-add-destination-steps-end


.. _destination-evocalize-add-data-template:
...
.. destination-evocalize-add-data-template-steps-start
...
.. destination-evocalize-add-data-template-steps-end
