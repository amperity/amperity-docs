...
.. important:: This topic assumes that you have completed the processes for :doc:`adding customer profiles <add_customer_profiles>` and :doc:`adding transactions <add_transactions>` to Amperity and have created your customer 360 database.
