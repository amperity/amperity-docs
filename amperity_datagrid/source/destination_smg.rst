...
.. |destination-name| replace:: SMG
.. |plugin-name| replace:: "SMG"
.. |credential-type| replace:: "smg"
...
.. meta::
    :description lang=en:
        Configure Amperity to send customer profiles to SMG.
...
.. destination-smg-get-details-table-start
...
.. destination-smg-get-details-table-end


.. _destination-smg-credentials:
...
**To configure credentials for SMG**

.. destination-smg-credentials-steps-start
...
.. destination-smg-credentials-steps-end


.. _destination-smg-add:
...
**To add a destination for SMG**

.. destination-smg-add-steps-start
