...
.. |destination-name| replace:: Criteo Retail Audience API
.. |plugin-name| replace:: "Criteo Retail Audience"
...
.. important:: OAuth for "Criteo Retail Audience API" *must* be completed within Criteo prior to configuring OAuth in Amperity.
