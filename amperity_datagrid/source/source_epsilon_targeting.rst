...
.. |source-name| replace:: Epsilon Targeting
.. |feed-name| replace:: CustomerRecords
.. |example-filename| replace:: filename_YYYY-MM-DD.csv
.. |domain-table-name| replace:: |source-name|:|feed-name|
.. |sftp-type| replace:: **epsilon-targeting**
.. |sftp-hostname| replace:: **sftp.epsilontargeting.com**
.. |what-pull| replace:: customer records
.. |filter-the-list| replace:: "eps"


.. meta::
    :description lang=en:
        Configure Amperity to pull data from Epsilon Targeting.
...
.. source-epsilon-targeting-steps-to-pull-start

.. include:: ../../shared/sources.rst
   :start-after: .. sources-overview-list-intro-start
   :end-before: .. sources-overview-list-intro-end

#. :ref:`Get details <source-epsilon-targeting-get-details>`
#. :ref:`Add data source <source-epsilon-targeting-add-data-source>`

.. source-epsilon-targeting-steps-to-pull-end


.. _source-epsilon-targeting-get-details:

Get details
==================================================

.. source-epsilon-targeting-get-details-start
...
.. source-epsilon-targeting-get-details-end


.. _source-epsilon-targeting-add-data-source:

Add data source and feed
==================================================

.. source-epsilon-targeting-add-data-source-intro-start-start
...
.. source-epsilon-targeting-add-data-source-intro-end

**To add a data source for any SFTP site**

.. source-epsilon-targeting-add-data-source-steps-start
...
.. source-epsilon-targeting-add-data-source-steps-end


.. _source-epsilon-targeting-workflow-actions:
...
.. source-epsilon-targeting-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`source-epsilon-targeting-workflow-actions-bad-archive`
       * :ref:`source-epsilon-targeting-workflow-actions-invalid-credentials`
       * :ref:`source-epsilon-targeting-workflow-actions-missing-file`
       * :ref:`source-epsilon-targeting-workflow-actions-sftp-unavailable`
       * :ref:`source-epsilon-targeting-workflow-actions-pgp-error`
       * :ref:`source-epsilon-targeting-workflow-actions-unable-to-decompress-archive`
...
.. source-epsilon-targeting-workflow-actions-end


.. _source-epsilon-targeting-workflow-actions-bad-archive:
...
.. _source-epsilon-targeting-workflow-actions-invalid-credentials:
...
.. _source-epsilon-targeting-workflow-actions-missing-file:
...
.. _source-epsilon-targeting-workflow-actions-pgp-error:
...
.. _source-epsilon-targeting-workflow-actions-sftp-unavailable:
...
.. _source-epsilon-targeting-workflow-actions-unable-to-decompress-archive:
