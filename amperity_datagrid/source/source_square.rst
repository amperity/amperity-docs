...
#. Access to an active |source-name| account using a private API key. Create an API key in |source-name| for use by FiveTran, and then provide the private API key to Amperity support. They will need this to complete the configuration of FiveTran.
