...
.. admonition:: What is Google Customer Match?
   ...
   * Send audiences to :doc:`DV360 <destination_dv360>`, and then run video advertising campaigns in |ext_youtube_ads_howitworks| or on web pages using any of the |ext_dv360_placement_options|. DV360 supports advertiser and partner networks.
...
.. important:: Customers must |ext_google_consent_object_faq| when uploading data for advertising to customers in the European Economic Area (EEA) and/or to adhere to the European Union (EU) user consent policy. Not including these signals may result in low match rates. 
