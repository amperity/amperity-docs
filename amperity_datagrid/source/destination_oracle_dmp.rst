...
.. |sendto-link| replace:: |sendto_oracle_dmp|
.. |channel-link| replace:: send campaign results


.. meta::
    :description lang=en:
        Configure Amperity to send data to Oracle DMP (BlueKai).
...
.. destination-oracle-dmp-steps-to-send-start

.. include:: ../../shared/destinations.rst
   :start-after: .. destinations-overview-list-intro-start
   :end-before: .. destinations-overview-list-intro-end

#. :ref:`Get details <destination-oracle-dmp-get-details>`
#. :ref:`Add destination <destination-oracle-dmp-add-destination>`
#. :ref:`Add data template <destination-oracle-dmp-add-data-template>`

.. destination-oracle-dmp-steps-to-send-end


.. _destination-oracle-dmp-get-details:

Get details
==================================================

.. destination-oracle-dmp-get-details-start
...
.. destination-oracle-dmp-get-details-end


.. _destination-oracle-dmp-add-destination:
...
.. destination-oracle-dmp-add-destination-steps-start
...
.. destination-oracle-dmp-add-destination-steps-end


.. _destination-oracle-dmp-add-data-template:
...
.. destination-oracle-dmp-add-data-template-steps-start
...
.. destination-oracle-dmp-add-data-template-steps-end


.. _destination-oracle-dmp-workflow-actions:
...
.. destination-oracle-dmp-workflow-actions-start
...
.. list-table::
   ...
   * - .. image:: ../../images/steps-03.png
     ...
     - .. include:: ../../shared/workflow-actions.rst
       ...
       * :ref:`destination-oracle-dmp-workflow-actions-invalid-credentials`
       * :ref:`destination-oracle-dmp-workflow-actions-sftp-unavailable`
...
.. destination-oracle-dmp-workflow-actions-end


.. _destination-oracle-dmp-workflow-actions-invalid-credentials:
...
.. _destination-oracle-dmp-workflow-actions-sftp-unavailable:
