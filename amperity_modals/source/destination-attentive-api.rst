...
|destination-name| is an automation platform for email and SMS marketing. Use the `Custom Attributes API <https://docs.attentivemobile.com/openapi/reference/tag/Custom-Attributes/>`__ |ext_link| to extend customer profiles in |destination-name| with attributes from Amperity.
