...
Important: This destination creates, deletes, subscribes, or unsubscribes contacts. Use the Listrak SMS -- Profile Updates connector to only update profiles for contacts that already exist in Listrak SMS.
