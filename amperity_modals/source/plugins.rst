...
A list of plugins for sources, destinations, campaigns, and journeys.
...
**instagram**
   ...
   .. include:: ../../shared/terms.rst
      :start-after: .. term-instagram-start
      :end-before: .. term-instagram-end


**facebook-messenger**

   .. include:: ../../shared/terms.rst
      :start-after: .. term-facebook-messenger-start
      :end-before: .. term-facebook-messenger-end


**whatsapp**

   .. include:: ../../shared/terms.rst
      :start-after: .. term-whatsapp-start
      :end-before: .. term-whatsapp-end
...
**meta-offline-events**
   ...
   Track offline conversions that result from your marketing campaigns in Meta Ads Manager. Events may be matched with audiences in Facebook, Facebook Messenger, Instagram, and WhatsApp.
...
**tradedesk-3rd-party**
   ...
   Monetize your brand's ID-based audiences by making them available to advertisers for more granular targeting with The Trade Desk.
...
**webhook**
   ...
   Build custom integrations between Amperity and programmatic workflows using Amazon S3 storage and an AWS Lambda function.
