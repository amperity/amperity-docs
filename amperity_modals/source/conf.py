...
htmlhelp_basename = 'Markdown'

# This doesn't enable the /support/ directory to automatically redirect to /support/index.html. The default is ''.
# html_baseurl = '/support/'
